...
namespace HundeRallyWebApp.Models.Hubs;
...
public class TrackHub : Hub
{
	...
	public async Task NodeMoved(int index, decimal x, decimal y)
	{
		await Clients.AllExcept(Context.ConnectionId).SendAsync("NodeMoved", index, x, y);
	}
}
